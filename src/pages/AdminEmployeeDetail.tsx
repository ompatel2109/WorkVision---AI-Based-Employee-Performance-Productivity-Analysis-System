...
import {
    ArrowLeft, Sparkles, Loader2, TrendingUp, TrendingDown, Minus,
...
export default function AdminEmployeeDetail() {
    ...
    const handleGenerateSummary = useCallback(async () => {
        ...
        try {
            const res = await api.get(`/admin/employee/${id}/ai-summary`);
    ...
    // Auto-generate summary once data is loaded
    useEffect(() => {
        if (data && !aiSummary && !isGeneratingSummary) {
            handleGenerateSummary();
        }
    }, [data, aiSummary, isGeneratingSummary, handleGenerateSummary]);
