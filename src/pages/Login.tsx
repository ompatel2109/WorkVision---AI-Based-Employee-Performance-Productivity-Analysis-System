...
import { ArrowLeft, Loader2, Sparkles, LogIn, ArrowRight, Activity } from 'lucide-react';
  ...
  return (
    <div className="min-h-[100dvh] flex items-center justify-center bg-[#0f172a] text-white p-4 sm:p-8 md:p-12 overflow-hidden font-sans selection:bg-indigo-500/30 relative">
      ...
      >
        ...
        {/* LEFT PANEL - PROFESSIONAL ISOMETRIC GRID (Inside the card) */}
        <div className="hidden lg:flex w-[55%] relative flex-col items-center justify-center border-r border-white/5 overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute bottom-[20%] left-[30%] w-[300px] h-[300px] bg-purple-600/20 rounded-full blur-[100px] z-10"
          />
            ...
            <div className="space-y-4 w-full">
              ...
              >
                ...
                <div className="flex-1 flex flex-col justify-center">
                  <span className="text-white text-sm font-bold tracking-wide mb-1">AI-Powered Analytics</span>
                  <span className="text-slate-400 text-xs text-left">Predictive performance insights.</span>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                className="p-4 rounded-xl bg-white/[0.02] border border-white/5 backdrop-blur-sm flex items-center gap-4 w-4/5 shadow-2xl ml-8"
              >
                ...
                <div className="flex-1 flex flex-col justify-center">
                  <span className="text-white text-sm font-bold tracking-wide mb-1">Real-time Tracking</span>
                  <span className="text-slate-400 text-xs text-left">Monitor your team's pulse.</span>
                </div>
              </motion.div>
            </div>
          </div>
        ...
        {/* RIGHT PANEL - CLEAN FORM (Inside the card) */}
        <div className="w-full lg:w-[45%] flex items-center justify-center p-8 sm:p-12 relative z-10 bg-[#030712] overflow-y-auto">
          ...
          <div className="w-full max-w-sm relative z-10">
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.2 }}>
              <Link to="/" className="inline-flex items-center gap-2 text-[11px] font-semibold tracking-widest uppercase text-slate-500 hover:text-white transition-colors mb-10 group">
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="mb-10">
              ...
              <h2 className="text-3xl font-bold tracking-tight mb-2 text-white">Secure Login</h2>
              <p className="text-slate-400 text-sm">Authenticate to access your organization's workspace.</p>
            </motion.div>
              ...
              <motion.div variants={formItem} className="space-y-2">
                ...
                <div className="relative group">
                  <Input
                    ...
                    required
                    className="h-12 bg-[#0a0f1e] border-white/5 text-white placeholder:text-slate-600 focus:bg-[#0f1526] focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/50 transition-all rounded-xl pl-4 pr-10 shadow-inner"
                  />
              ...
              <motion.div variants={formItem} className="space-y-2">
                ...
                <div className="relative group">
                  <Input
                    ...
                    required
                    className="h-12 bg-[#0a0f1e] border-white/5 text-white placeholder:text-slate-600 focus:bg-[#0f1526] focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/50 transition-all rounded-xl pl-4 pr-10 tracking-[0.2em] shadow-inner"
                  />
                  <div className="absolute top-0 left-0 w-2 h-2 border-t-2 border-l-2 border-indigo-500 rounded-tl-xl opacity-0 group-focus-within:opacity-100 transition-opacity pointer-events-none" />
                  <div className="absolute bottom-0 right-0 w-2 h-2 border-b-2 border-r-2 border-indigo-500 rounded-br-xl opacity-0 group-focus-within:opacity-100 transition-opacity pointer-events-none" />
                </div>
              ...
              <motion.div variants={formItem} className="pt-2">
                ...
                >
                  ...
                  {isLoading ? (
                    ...
                    <span className="flex items-center gap-2 relative z-10">
                      Connect <ArrowRight className="h-4 w-4 opacity-70 group-hover:translate-x-1 group-hover:opacity-100 transition-all" />
                    </span>
                  )}
                </Button>
              </motion.div>
            ...
            <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.8 }} className="mt-8 text-center text-[13px] text-slate-500">
              Don't have an account?{' '}
              <Link to="/register" className="font-semibold text-white hover:text-indigo-400 transition-colors underline decoration-white/20 hover:decoration-indigo-400 underline-offset-4">
                Sign up
              </Link>
            </motion.p>
          </div>
